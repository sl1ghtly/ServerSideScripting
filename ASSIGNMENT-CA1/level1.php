...
<body>
    ...
    //double the cards in the array because they need pairs
    ...
    <div class="wrapper">
        ...
        {
            //get the key value from checkbox and check if it's a red card, if nothing is selected adds a 0.5
            ...
            {
                //if card is red then move to gameover
                if ($key == 'cardRed_png')
                {
