...
<body>
    ...
    <div class="wrapper">
            ...
            <p><b>Enter the ID of the movie to edit and then edit the details. (Do not use "'")</b></p>
            ...
            <br>
            <button type="submit" name="submit" class="btn btn-outline-danger">Edit the Movie in the Database</button>
            </form>
    </div>
    <br><br>
    <div class="wrapper">
